...
RUN apt-get -y update && \
	apt-get -y install --no-install-recommends less=590-1ubuntu0.22.04.2  && \
...
LABEL org.opencontainers.image.url=https://github.com/gnzsnz/pgcli-docker/pkgs/container/pgcli-docker
